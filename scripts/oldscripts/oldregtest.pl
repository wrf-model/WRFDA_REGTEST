...
#        $ENV{CRTM} ='/karri/users/xinzhang/external/gfortran_web/crtm';
        $ENV{CRTM}='1';
        $ENV{BUFR}='1';
#        $ENV{RTTOV} ='/loblolly2/kavulich/REGRESSION/rttov101/gfortran-openmp';
#        $ENV{RTTOV} ='/karri/users/jliu/rttov';
...
foreach my $option (sort keys %Compile_options) {
     ...
     die "The number of exe files is less than 41. \n" if (@exefiles < 41);
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      /loblolly2/kavulich/REGRESSION/SUBV/wrfda5800.tar        gfortran         64000420  share   /loblolly2/kavulich/REGRESSION/WRFDA-data-EM    /loblolly2/kavulich/REGRESSION/BASELINE.NEW
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      /loblolly2/kavulich/REGRESSION/WRFDA34/WRFDA_V3.4.tar        pgi         64000420  share   /loblolly2/kavulich/REGRESSION/WRFDA-data-EM    /loblolly2/kavulich/REGRESSION/BASELINE.NEW
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
1        tutorial_xinzhang           8       8            serial|dmpar
2        cv3_guo                     8       8            serial|dmpar
3        t44_liuz                    8       8            serial|dmpar
