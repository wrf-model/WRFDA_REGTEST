...
sub new_job {
     ...
     foreach my $bufr_file (glob("*.bufr")) {
         ...
         `cwordsh unblk $bufr_file $bufr_file.unblk >& /dev/null`;
         `cwordsh block $bufr_file.unblk $bufr_file.block >& /dev/null`;
         #chdir "../$nam" or die "Cannot chdir to ../$nam : $!\n";
...
sub compare2baseline {
     ...
     my @output = `diffwrf $name/wrfvar_output.$Arch.$name.$par.$Compiler $Baseline/wrfvar_output.$Arch.$name.$par.$Compiler`;
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
AIX      /blhome/jliu/regtest/WRFDA.tar          XLF         64000510  share /ptmp/jliu/regtest/WRFDA-data-EM  /mmm/users/wrfhelp/data/BASELINE
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      /loblolly/kavulich/wrfda.tar        ifort         64000420  share   /loblolly/kavulich/WRFDA-data-EM    /loblolly/kavulich/BASELINE
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      /loblolly2/kavulich/REGRESSION/SUBV/wrfda5970.tar        gfortran         64000420  share   /loblolly2/kavulich/REGRESSION/WRFDA-data-EM    /loblolly2/kavulich/REGRESSION/BASELINE.NEW
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      /loblolly2/kavulich/REGRESSION/SUBV/wrfda5960.tar        pgi         64000420  share   /loblolly2/kavulich/REGRESSION/WRFDA-data-EM    /loblolly2/kavulich/REGRESSION/BASELINE.NEW
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
1        tutorial_xinzhang           8       8            serial|dmpar
2        cv3_guo                     8       8            serial|dmpar
3        t44_liuz                    8       8            serial|dmpar
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Darwin     wrfda.tar        pgi         64000420  share   /data3/mp/wrfhelp/data//WRFDA-data-EM    /data3/mp/wrfhelp/data//BASELINE
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
...
###########################################################################################
#ARCH      SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Darwin     wrfda.tar        g95         64000420  share   /data3/mp/wrfhelp/data//WRFDA-data-EM    /data3/mp/wrfhelp/data//BASELINE
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
