  ...
  foreach (@output) {
    if ( ($Machine_name eq "yellowstone") ) {
       if ($Compiler eq "gfortran" ) {
          if ($_=~ m/(\d+)\. .*$Compiler .* $CCompiler .* ($Par) .*/ix) {
             $Compile_options{$1} = $2;
          }
       } else {
          if ($_=~ m/(\d+)\. .*$Compiler .* $CCompiler .* YELLOWSTONE .* ($Par) .*/ix) {
             $Compile_options{$1} = $2;
          }
       }
    } else {
  ...
  foreach (@output) {
    if ( ($Machine_name eq "yellowstone") ) {
       if ($Compiler eq "gfortran" ) {
          ...
          if ($_=~ m/(\d+)\. .*$Compiler .* $CCompiler .* YELLOWSTONE .* ($Par_4dvar) .*/ix) {
             $Compile_options_4dvar{$1} = $2;
          }
       }
    } else {
...
###########################################################################################
#ARCH      MACHINE     NAME     SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      x86_64  yellowstone    /glade/p/work/kavulich/REGRESSION/WRFDA_V3.5.1.tar        ifort         P64000510  caldera   /glade/p/work/kavulich/REGRESSION/WRFDA-data-EM    /glade/p/work/kavulich/REGRESSION/BASELINE.NEW
...
###########################################################################################
#ARCH      MACHINE     NAME     SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      x86_64  yellowstone    /glade/p/work/kavulich/REGRESSION/WRFDA_V3.5.1.tar        gfortran      P64000510  caldera   /glade/p/work/kavulich/REGRESSION/WRFDA-data-EM    /glade/p/work/kavulich/REGRESSION/BASELINE.NEW
#INDEX   EXPERIMENT                  TYPE            CPU   OPENMP  PAROPT
1        afwa_t7_ssmi                3DVAR            8    16      serial|dmpar
2        afwa_t7_ssmi_32             3DVAR            8    16      serial|dmpar
3        ASR_prepbufr                3DVAR           16    16      serial|dmpar
...
###########################################################################################
#ARCH      MACHINE     NAME     SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      x86_64  yellowstone    /glade/p/work/kavulich/REGRESSION/WRFDA_V3.5.1.tar        pgi      P64000510  caldera   /glade/p/work/kavulich/REGRESSION/WRFDA-data-EM    /glade/p/work/kavulich/REGRESSION/BASELINE.ARCHIVE/351-debug
#INDEX   EXPERIMENT                  TYPE            CPU   OPENMP  PAROPT
1        afwa_t7_ssmi                3DVAR            8    16      serial|dmpar
2        afwa_t7_ssmi_32             3DVAR            8    16      serial|dmpar
3        ASR_prepbufr                3DVAR           16    16      serial|dmpar
...
###########################################################################################
#ARCH      MACHINE     NAME     SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
Linux      x86_64  loblolly    /loblolly2/kavulich/REGRESSION/WRFDA_V3.5.tar        pgi         64000510  share   /loblolly2/kavulich/REGRESSION/WRFDA-data-EM    /loblolly2/kavulich/REGRESSION/BASELINE.NEW
#INDEX   EXPERIMENT                  CPU     OPENMP       PAROPT
#1        afwa_t7_ssmi                3DVAR            6    16      serial|dmpar
#2        afwa_t7_ssmi_32             3DVAR            6    16      serial|dmpar
#3        ASR_prepbufr                3DVAR            6    16      serial|dmpar
#4        cv3_guo                     3DVAR            6    16      serial|dmpar
#5        cv3_guo_32                  3DVAR            6    16      serial|dmpar
#6        cwb_ascii                   3DVAR            6    16      serial|dmpar
#7        cwb_ascii_outerloop_rizvi   3DVAR            6    16      serial|dmpar
#8        iasi_dmxu                   3DVAR            6    16      dmpar
#9        outerloop_bench_guo         3DVAR            6    16      serial|dmpar
#10       outerloop_ztd_bench_guo     3DVAR            1    16      serial|dmpar
#11       radar_meixu                 3DVAR            4    16      serial|dmpar
#12       sfc_assi_2_outerloop_guo    3DVAR            6    16      serial|dmpar
#13       t44_liuz                    3DVAR            1    16      serial|dmpar
#14       t44_prepbufr                3DVAR            4    16      serial|dmpar
15       tutorial_4dvar              4DVAR            6    16      dmpar
#16       tutorial_xinzhang           3DVAR            6    16      serial|dmpar
#17       tutorial_xinzhang_32        3DVAR            6    16      serial|dmpar
#18       tutorial_xinzhang_kmatrix   3DVAR            3    16      serial|dmpar
#19       tutorial_xinzhang_rttov     3DVAR            6    16      serial|dmpar
#20       wind_sd                     3DVAR            6    16      serial|dmpar
############################################################################################
#ARCH      MACHINE     NAME     SOURCE     COMPILER    PROJECT   QUEUE   DATABASE                             BASELINE
